...
# There is one individual that is clearly misclassified in 2001 - an age 1, mature fish at 44 cm. Sablefish never mature that young or that small.
sabl_hist <- subset(sabl_hist, !(sample_no == "OR010846" & fish_length == 440 & age1 == "1"))
...
```{r create_color_scale}
fig1_color_scale = c("1: Immature" = "#4E79A7",  
                     "2: Maturing" = "#F28E2B", 
                     "3: Vitellogenesis" = "#E15759",
                     "4: Fertilized" = "#76B7B2",
                     "5: Ripe" = "#59A14F", 
                     "6: Spent" = "#EDC948",
                     "7: Resting" = "#B07AA1", 
...
cnry_code_plot <- ggplot(cnry_f_mat_codes, aes(x = sample_year, y = n, fill = Stage))+
  ...
  scale_fill_manual(values = fig1_color_scale) +
  xlab("Year")+
...
ggsave(paste0(fig_dir, "/Fig1_cnry.eps"), cnry_code_plot, height = 7, width = 12)
```
...
sabl_code_plot <- ggplot(sabl_f_mat_codes, aes(x = sample_year, y = n, fill = Stage))+
  geom_bar(stat = "identity")+
  scale_fill_manual(values = fig4_color_scale) +
  xlab("Year")+
  ylab("Number of Samples")+
  theme(axis.text = element_text(size = 15),
        axis.title = element_text(size = 20),
...
ggsave(paste0(fig_dir, "/Fig1_sabl.eps"), sabl_code_plot, height = 7, width = 12)
```
...
ggsave(paste0(fig_dir, "/Fig1.eps"), fig4, height = 14, width = 12)
```
...
### Spawning season, no 7s no 8s and no fish >= 70 cm that are immature. 1997-1998 ENSO REMOVED
```{r fit_glm_sabl_no7no8_no70immature_ENSO_sensitivity}
### Subset data
sabl_f_spwn_no70immature_no7no8_95_01 %>% 
  subset(., !(sample_year == 1998 & sample_month %in% c(1,2))) -> sabl_f_spwn_no70immature_no7no8_95_01_noENSO

table(sabl_f_spwn_no70immature_no7no8_95_01$macro_maturity, sabl_f_spwn_no70immature_no7no8_95_01$fork_length)
table(sabl_f_spwn_no70immature_no7no8_95_01_noENSO$macro_maturity, sabl_f_spwn_no70immature_no7no8_95_01_noENSO$fork_length)

### 1995-2001, no ENSO ###
fit.mat.glm.sabl_spwn_no70immature_no7no8_95_01_noENSO <- glm(maturity ~ 1 + length, data <-data.frame(length = sabl_f_spwn_no70immature_no7no8_95_01_noENSO$length_cm, maturity <- sabl_f_spwn_no70immature_no7no8_95_01_noENSO$macro_maturity),
                                                       family = binomial(link ="logit"))
vector.sabl_spwn_no70immature_no7no8_95_01_noENSO = c(fit.mat.glm.sabl_spwn_no70immature_no7no8_95_01_noENSO$coefficients)

# A_glm = intercept
# B_glm = slope

A_glm.sabl_spwn_no70immature_no7no8_95_01_noENSO <- vector.sabl_spwn_no70immature_no7no8_95_01_noENSO[1] 
B_glm.sabl_spwn_no70immature_no7no8_95_01_noENSO <- vector.sabl_spwn_no70immature_no7no8_95_01_noENSO[2]
Lmat50.sabl_spwn_no70immature_no7no8_95_01_noENSO = -(A_glm.sabl_spwn_no70immature_no7no8_95_01_noENSO/B_glm.sabl_spwn_no70immature_no7no8_95_01_noENSO)
Lmat50.sabl_spwn_no70immature_no7no8_95_01_noENSO

cor(sabl_f_spwn_no70immature_no7no8_95_01_noENSO$length_cm, sabl_f_spwn_no70immature_no7no8_95_01_noENSO$macro_maturity)

sA.sabl_spwn_no70immature_no7no8_95_01_noENSO <- summary (fit.mat.glm.sabl_spwn_no70immature_no7no8_95_01_noENSO)$coef[1,2] 
sB.sabl_spwn_no70immature_no7no8_95_01_noENSO <- summary (fit.mat.glm.sabl_spwn_no70immature_no7no8_95_01_noENSO)$coef[2,2]    
r.sabl_spwn_no70immature_no7no8_95_01_noENSO <-cor(sabl_f_spwn_no70immature_no7no8_95_01_noENSO$length_cm, sabl_f_spwn_no70immature_no7no8_95_01_noENSO$macro_maturity)
n.1 <- length(sabl_f_spwn_no70immature_no7no8_95_01_noENSO$length_cm)

#Variance estimator
deltamethod.sabl_spwn_no70immature_no7no8_95_01_noENSO <- ((sA.sabl_spwn_no70immature_no7no8_95_01_noENSO^2)/(B_glm.sabl_spwn_no70immature_no7no8_95_01_noENSO^2))- ((2*A_glm.sabl_spwn_no70immature_no7no8_95_01_noENSO*sA.sabl_spwn_no70immature_no7no8_95_01_noENSO*sB.sabl_spwn_no70immature_no7no8_95_01_noENSO*r.sabl_spwn_no70immature_no7no8_95_01_noENSO)/(B_glm.sabl_spwn_no70immature_no7no8_95_01_noENSO^3))+ (((A_glm.sabl_spwn_no70immature_no7no8_95_01_noENSO^2)*(sB.sabl_spwn_no70immature_no7no8_95_01_noENSO^2))/(B_glm.sabl_spwn_no70immature_no7no8_95_01_noENSO^4))
deltamethod.sabl_spwn_no70immature_no7no8_95_01_noENSO

## 95% Confidence Interval equation

con.sabl_spwn_no70immature_no7no8_95_01_noENSO <- 1.96*(sqrt(deltamethod.sabl_spwn_no70immature_no7no8_95_01_noENSO)/sqrt(n.1))
sabl_spwn_no70immature_no7no8_95_01_noENSO_mat <- c(Lmat50.sabl_spwn_no70immature_no7no8_95_01_noENSO,con.sabl_spwn_no70immature_no7no8_95_01_noENSO)

sabl_spwn_no70immature_no7no8_95_01_mat
sabl_spwn_no70immature_no7no8_95_01_noENSO_mat
```
...
cnry_80_84_glm_results$spawning_season_isolated <- c("No", "No", "Yes", "Yes")
```
...
cnry_10_18_glm_results$spawning_season_isolated <- c("No", "No", "Yes", "Yes")
```
...
# Reorder columns for table, remove column 1, which is the name of the file
cnry_hist_sensitivity_table_forexport <- cnry_hist_sensitivity_table[,c(4, 9, 10, 8, 2, 3, 5, 6, 7)]

write.csv(cnry_hist_sensitivity_table_forexport, here("tables", "canary_historical_sensitivity_table.csv"), row.names = FALSE)
```
...
sabl_f_95_01_glm_results$spawning_season_isolated <- c("No", "No", "No", "Yes", "Yes")
...
sabl_f_07_18_glm_results$time_period <- "2007-2018"
...
sabl_f_07_18_glm_results$spawning_season_isolated <- c("No", "No", "No", "Yes", "Yes")
...
# Reorder columns for table, remove column 1, which is the name of the file
sabl_hist_sensitivity_table_forexport <- sabl_hist_sensitivity_table[,c(4, 9, 10, 11, 8, 2, 3, 5, 6, 7)]

write.csv(sabl_hist_sensitivity_table_forexport, here("tables", "sablefish_historical_sensitivity_table.csv"), row.names = FALSE)
```
...
### FIG 3: Spawning season, no 7s and no 8s
...
### CREATE PLOT - save as fig3
setEPS()
postscript(here("figures", "historical_sensitivity_analysis", "Fig3.eps"), height = 8, width = 8)
...
### FIG 4: Spawning season, no 7s no 8s and no fish >= 70 cm that are immature
...
### CREATE PLOT - save as fig4
setEPS()
postscript(here("figures", "historical_sensitivity_analysis", "Fig4.eps"), height = 8, width = 8)
