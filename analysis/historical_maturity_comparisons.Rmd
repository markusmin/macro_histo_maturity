...
fig4_color_scale = c("1: Immature" = "#4E79A7",  
                     "2: Maturing" = "#F28E2B", 
...
# Reorder columns for table, remove some (columns 1 and 3, which are the names of the files and the plusminusCI95)
cnry_hist_sensitivity_table_forexport <- cnry_hist_sensitivity_table[,c(4, 9, 10, 8, 2, 5, 6, 7)]
...
# Reorder columns for table, remove some (columns 1 and 3, which are the names of the files and the plusminusCI95)
sabl_hist_sensitivity_table_forexport <- sabl_hist_sensitivity_table[,c(4, 9, 10, 11, 8, 2, 5, 6, 7)]
