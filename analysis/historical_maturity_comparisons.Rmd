...
- Remove problematic codes:
  - 7 (resting) - high degree of mis-assignment
  - 8 (mature) - no way of assessing accuracy because this code is no longer used
- Remove clearly mis-assigned fish: immature fish >= 65 cm
...
### All seasons, all codes, large immature fish (>= 65 cm) REMOVED
sabl_f_no65immature <- subset(sabl_f, !(fish_length >= 650 & maturity_agcode %in% c(1, 2)))

# Subset 1995-2001
sabl_f_no65immature_95_01 <- subset(sabl_f_no65immature, sample_year %in% c(1995, 1996, 1997, 1998, 1999, 2000, 2001))

# Subset 2007-2018
sabl_f_no65immature_07_18 <- subset(sabl_f_no65immature, sample_year %in% c(2007, 2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018))


### Spawning season, all codes, large immature fish (>= 65 cm) REMOVED
subset(sabl_f_no65immature, sample_month >= 10 | sample_month <= 2) -> sabl_f_spwn_no65immature


# Subset 1995-2001
sabl_f_spwn_no65immature_95_01 <- subset(sabl_f_spwn_no65immature, sample_year %in% c(1995, 1996, 1997, 1998, 1999, 2000, 2001))

# Subset 2007-2018
sabl_f_spwn_no65immature_07_18 <- subset(sabl_f_spwn_no65immature, sample_year %in% c(2007, 2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018))


### Spawning season, no 7 no 8, large immature fish (>= 65 cm) REMOVED
subset(sabl_f_no65immature, sample_month >= 10 | sample_month <= 2) %>% 
  subset(., !(maturity_agcode %in% c(7, 8))) -> sabl_f_spwn_no65immature_no7no8

# Subset 1995-2001
sabl_f_spwn_no65immature_no7no8_95_01 <- subset(sabl_f_spwn_no65immature_no7no8, sample_year %in% c(1995, 1996, 1997, 1998, 1999, 2000, 2001))

# Subset 2007-2018
sabl_f_spwn_no65immature_no7no8_07_18 <- subset(sabl_f_spwn_no65immature_no7no8, sample_year %in% c(2007, 2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018))

### All seasons, no 7 no 8, no fish >= 65 cm that are immature
sabl_f_no65immature %>% 
  subset(., !(maturity_agcode %in% c(7, 8))) -> sabl_f_no7no8_no65immature


# Subset 1995-2001
sabl_f_no7no8_no65immature_95_01 <- subset(sabl_f_no7no8_no65immature, sample_year %in% c(1995, 1996, 1997, 1998, 1999, 2000, 2001))

# Subset 2007-2018
sabl_f_no7no8_no65immature_07_18 <- subset(sabl_f_no7no8_no65immature, sample_year %in% c(2007, 2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018))
```
...
#### All seasons, all codes, no immature fish >= 65 cm
```{r sabl_calc_maturity_props_allseasons_allcodes_no65immature}

### 1995-2001 ###

# Calculate proportion mature at each length
sabl_f_no65immature_95_01 %>% 
  mutate(length_cm = round(fish_length/10,0)) %>% 
  group_by(length_cm) %>% 
  summarise(prop_mature = mean(macro_maturity)) -> sabl_prop_mature_f_no65immature_95_01
...
sabl_f_no65immature_95_01 %>% 
  ...
  count(spid) %>% 
  dplyr::select(-spid) %>% 
  right_join(., sabl_prop_mature_f_no65immature_95_01, by = "length_cm") -> sabl_prop_mature_f_no65immature_95_01

### 2007-2018 ###

# Calculate proportion mature at each length
sabl_f_no65immature_07_18 %>% 
  mutate(length_cm = round(fish_length/10,0)) %>% 
  group_by(length_cm) %>% 
  summarise(prop_mature = mean(macro_maturity)) -> sabl_prop_mature_f_no65immature_07_18
...
sabl_f_no65immature_07_18 %>% 
  ...
  count(spid) %>% 
  dplyr::select(-spid) %>% 
  right_join(., sabl_prop_mature_f_no65immature_07_18, by = "length_cm") -> sabl_prop_mature_f_no65immature_07_18

```

#### All seasons, no 7 no 8, no immature fish >= 65 cm
```{r sabl_calc_maturity_props_allseasons_allcodes_no7no8_no65immature}

### 1995-2001 ###

# Calculate proportion mature at each length
sabl_f_no7no8_no65immature_95_01 %>% 
  mutate(length_cm = round(fish_length/10,0)) %>% 
  group_by(length_cm) %>% 
  summarise(prop_mature = mean(macro_maturity)) -> sabl_prop_mature_f_no7no8_no65immature_95_01
...
sabl_f_no7no8_no65immature_95_01 %>% 
  ...
  count(spid) %>% 
  dplyr::select(-spid) %>% 
  right_join(., sabl_prop_mature_f_no7no8_no65immature_95_01, by = "length_cm") -> sabl_prop_mature_f_no7no8_no65immature_95_01

### 2007-2018 ###

# Calculate proportion mature at each length
sabl_f_no7no8_no65immature_07_18 %>% 
  mutate(length_cm = round(fish_length/10,0)) %>% 
  group_by(length_cm) %>% 
  summarise(prop_mature = mean(macro_maturity)) -> sabl_prop_mature_f_no7no8_no65immature_07_18
...
sabl_f_no7no8_no65immature_07_18 %>% 
  ...
  count(spid) %>% 
  dplyr::select(-spid) %>% 
  right_join(., sabl_prop_mature_f_no7no8_no65immature_07_18, by = "length_cm") -> sabl_prop_mature_f_no7no8_no65immature_07_18

```


#### Spawning season, all codes, no fish >= 65 cm that are immature
```{r sabl_calc_maturity_props_allcodes_no65immature}
### 1995-2001 ###

# Calculate proportion mature at each length
sabl_f_spwn_no65immature_95_01 %>% 
  mutate(length_cm = round(fish_length/10,0)) %>% 
  group_by(length_cm) %>% 
  summarise(prop_mature = mean(macro_maturity)) -> sabl_prop_mature_f_spwn_no65immature_95_01
...
sabl_f_spwn_no65immature_95_01 %>% 
  ...
  count(spid) %>% 
  dplyr::select(-spid) %>% 
  right_join(., sabl_prop_mature_f_spwn_no65immature_95_01, by = "length_cm") -> sabl_prop_mature_f_spwn_no65immature_95_01

### 2007-2018 ###

# Calculate proportion mature at each length
sabl_f_spwn_no65immature_07_18 %>% 
  mutate(length_cm = round(fish_length/10,0)) %>% 
  group_by(length_cm) %>% 
  summarise(prop_mature = mean(macro_maturity)) -> sabl_prop_mature_f_spwn_no65immature_07_18
...
sabl_f_spwn_no65immature_07_18 %>% 
  ...
  count(spid) %>% 
  dplyr::select(-spid) %>% 
  right_join(., sabl_prop_mature_f_spwn_no65immature_07_18, by = "length_cm") -> sabl_prop_mature_f_spwn_no65immature_07_18
```

#### Spawning season, no 7 no 8, no fish >= 65 cm that are immature
```{r sabl_calc_maturity_props_no65immature_no7no8}
### 1995-2001 ###

# Calculate proportion mature at each length
sabl_f_spwn_no65immature_no7no8_95_01 %>% 
  mutate(length_cm = round(fish_length/10,0)) %>% 
  group_by(length_cm) %>% 
  summarise(prop_mature = mean(macro_maturity)) -> sabl_prop_mature_f_spwn_no65immature_no7no8_95_01
...
sabl_f_spwn_no65immature_no7no8_95_01 %>% 
  ...
  count(spid) %>% 
  dplyr::select(-spid) %>% 
  right_join(., sabl_prop_mature_f_spwn_no65immature_no7no8_95_01, by = "length_cm") -> sabl_prop_mature_f_spwn_no65immature_no7no8_95_01

### 2007-2018 ###

# Calculate proportion mature at each length
sabl_f_spwn_no65immature_no7no8_07_18 %>% 
  mutate(length_cm = round(fish_length/10,0)) %>% 
  group_by(length_cm) %>% 
  summarise(prop_mature = mean(macro_maturity)) -> sabl_prop_mature_f_spwn_no65immature_no7no8_07_18
...
sabl_f_spwn_no65immature_no7no8_07_18 %>% 
  ...
  count(spid) %>% 
  dplyr::select(-spid) %>% 
  right_join(., sabl_prop_mature_f_spwn_no65immature_no7no8_07_18, by = "length_cm") -> sabl_prop_mature_f_spwn_no65immature_no7no8_07_18
```
...
### All seasons, all codes, no immature fish >= 65cm
```{r fit_glm_sabl_allseasons_allcodes_no65immature}

### 1995-2001 ###

fit.mat.glm.sabl_f_no65immature_95_01 <- glm(maturity ~ 1 + length, data <-data.frame(length = sabl_f_no65immature_95_01$length_cm, maturity <- sabl_f_no65immature_95_01$macro_maturity),
                                family = binomial(link ="logit"))
vector.sabl_f_no65immature_95_01 = c(fit.mat.glm.sabl_f_no65immature_95_01$coefficients)

# A_glm = intercept
# B_glm = slope

A_glm.sabl_f_no65immature_95_01 <- vector.sabl_f_no65immature_95_01[1] 
B_glm.sabl_f_no65immature_95_01 <- vector.sabl_f_no65immature_95_01[2]
Lmat50.sabl_f_no65immature_95_01 = -(A_glm.sabl_f_no65immature_95_01/B_glm.sabl_f_no65immature_95_01)
Lmat50.sabl_f_no65immature_95_01

cor(sabl_f_no65immature_95_01$length_cm, sabl_f_no65immature_95_01$macro_maturity)

sA.sabl_f_no65immature_95_01 <- summary (fit.mat.glm.sabl_f_no65immature_95_01)$coef[1,2] 
sB.sabl_f_no65immature_95_01 <- summary (fit.mat.glm.sabl_f_no65immature_95_01)$coef[2,2]    
r.sabl_f_no65immature_95_01 <-cor(sabl_f_no65immature_95_01$length_cm, sabl_f_no65immature_95_01$macro_maturity)
n.1 <- length(sabl_f_no65immature_95_01$length_cm)

#Variance estimator
deltamethod.sabl_f_no65immature_95_01 <- ((sA.sabl_f_no65immature_95_01^2)/(B_glm.sabl_f_no65immature_95_01^2))- ((2*A_glm.sabl_f_no65immature_95_01*sA.sabl_f_no65immature_95_01*sB.sabl_f_no65immature_95_01*r.sabl_f_no65immature_95_01)/(B_glm.sabl_f_no65immature_95_01^3))+ (((A_glm.sabl_f_no65immature_95_01^2)*(sB.sabl_f_no65immature_95_01^2))/(B_glm.sabl_f_no65immature_95_01^4))
deltamethod.sabl_f_no65immature_95_01

## 95% Confidence Interval equation

con.sabl_f_no65immature_95_01 <- 1.96*(sqrt(deltamethod.sabl_f_no65immature_95_01)/sqrt(n.1))
sabl_f_no65immature_95_01_mat = c(Lmat50.sabl_f_no65immature_95_01,con.sabl_f_no65immature_95_01)


### 2007-2018 ###

fit.mat.glm.sabl_f_no65immature_07_18 <- glm(maturity ~ 1 + length, data <-data.frame(length = sabl_f_no65immature_07_18$length_cm, maturity <- sabl_f_no65immature_07_18$macro_maturity),
                                family = binomial(link ="logit"))
vector.sabl_f_no65immature_07_18 = c(fit.mat.glm.sabl_f_no65immature_07_18$coefficients)

# A_glm = intercept
# B_glm = slope

A_glm.sabl_f_no65immature_07_18 <- vector.sabl_f_no65immature_07_18[1] 
B_glm.sabl_f_no65immature_07_18 <- vector.sabl_f_no65immature_07_18[2]
Lmat50.sabl_f_no65immature_07_18 = -(A_glm.sabl_f_no65immature_07_18/B_glm.sabl_f_no65immature_07_18)
Lmat50.sabl_f_no65immature_07_18

cor(sabl_f_no65immature_07_18$length_cm, sabl_f_no65immature_07_18$macro_maturity)

sA.sabl_f_no65immature_07_18 <- summary (fit.mat.glm.sabl_f_no65immature_07_18)$coef[1,2] 
sB.sabl_f_no65immature_07_18 <- summary (fit.mat.glm.sabl_f_no65immature_07_18)$coef[2,2]    
r.sabl_f_no65immature_07_18 <-cor(sabl_f_no65immature_07_18$length_cm, sabl_f_no65immature_07_18$macro_maturity)
n.1 <- length(sabl_f_no65immature_07_18$length_cm)

#Variance estimator
deltamethod.sabl_f_no65immature_07_18 <- ((sA.sabl_f_no65immature_07_18^2)/(B_glm.sabl_f_no65immature_07_18^2))- ((2*A_glm.sabl_f_no65immature_07_18*sA.sabl_f_no65immature_07_18*sB.sabl_f_no65immature_07_18*r.sabl_f_no65immature_07_18)/(B_glm.sabl_f_no65immature_07_18^3))+ (((A_glm.sabl_f_no65immature_07_18^2)*(sB.sabl_f_no65immature_07_18^2))/(B_glm.sabl_f_no65immature_07_18^4))
deltamethod.sabl_f_no65immature_07_18

## 95% Confidence Interval equation

con.sabl_f_no65immature_07_18 <- 1.96*(sqrt(deltamethod.sabl_f_no65immature_07_18)/sqrt(n.1))
sabl_f_no65immature_07_18_mat = c(Lmat50.sabl_f_no65immature_07_18,con.sabl_f_no65immature_07_18)
```



### All seasons, no 7s no 8s and no fish >= 65 cm that are immature
```{r fit_glm_sabl_no7no8_no65immature}

### 1995-2001 ###

fit.mat.glm.sabl_no7no8_no65immature_95_01 <- glm(maturity ~ 1 + length, data <-data.frame(length = sabl_f_no7no8_no65immature_95_01$length_cm, maturity <- sabl_f_no7no8_no65immature_95_01$macro_maturity),
                                                       family = binomial(link ="logit"))
vector.sabl_no7no8_no65immature_95_01 = c(fit.mat.glm.sabl_no7no8_no65immature_95_01$coefficients)

# A_glm = intercept
# B_glm = slope

A_glm.sabl_no7no8_no65immature_95_01 <- vector.sabl_no7no8_no65immature_95_01[1] 
B_glm.sabl_no7no8_no65immature_95_01 <- vector.sabl_no7no8_no65immature_95_01[2]
Lmat50.sabl_no7no8_no65immature_95_01 = -(A_glm.sabl_no7no8_no65immature_95_01/B_glm.sabl_no7no8_no65immature_95_01)
Lmat50.sabl_no7no8_no65immature_95_01

cor(sabl_f_no7no8_no65immature_95_01$length_cm, sabl_f_no7no8_no65immature_95_01$macro_maturity)

sA.sabl_no7no8_no65immature_95_01 <- summary (fit.mat.glm.sabl_no7no8_no65immature_95_01)$coef[1,2] 
sB.sabl_no7no8_no65immature_95_01 <- summary (fit.mat.glm.sabl_no7no8_no65immature_95_01)$coef[2,2]    
r.sabl_no7no8_no65immature_95_01 <-cor(sabl_f_no7no8_no65immature_95_01$length_cm, sabl_f_no7no8_no65immature_95_01$macro_maturity)
n.1 <- length(sabl_f_no7no8_no65immature_95_01$length_cm)

#Variance estimator
deltamethod.sabl_no7no8_no65immature_95_01 <- ((sA.sabl_no7no8_no65immature_95_01^2)/(B_glm.sabl_no7no8_no65immature_95_01^2))- ((2*A_glm.sabl_no7no8_no65immature_95_01*sA.sabl_no7no8_no65immature_95_01*sB.sabl_no7no8_no65immature_95_01*r.sabl_no7no8_no65immature_95_01)/(B_glm.sabl_no7no8_no65immature_95_01^3))+ (((A_glm.sabl_no7no8_no65immature_95_01^2)*(sB.sabl_no7no8_no65immature_95_01^2))/(B_glm.sabl_no7no8_no65immature_95_01^4))
deltamethod.sabl_no7no8_no65immature_95_01

## 95% Confidence Interval equation

con.sabl_no7no8_no65immature_95_01 <- 1.96*(sqrt(deltamethod.sabl_no7no8_no65immature_95_01)/sqrt(n.1))
sabl_no7no8_no65immature_95_01_mat = c(Lmat50.sabl_no7no8_no65immature_95_01,con.sabl_no7no8_no65immature_95_01)


### 2007-2018 ###

fit.mat.glm.sabl_no7no8_no65immature_07_18 <- glm(maturity ~ 1 + length, data <-data.frame(length = sabl_f_no7no8_no65immature_07_18$length_cm, maturity <- sabl_f_no7no8_no65immature_07_18$macro_maturity),
                                                       family = binomial(link ="logit"))
vector.sabl_no7no8_no65immature_07_18 = c(fit.mat.glm.sabl_no7no8_no65immature_07_18$coefficients)

# A_glm = intercept
# B_glm = slope

A_glm.sabl_no7no8_no65immature_07_18 <- vector.sabl_no7no8_no65immature_07_18[1] 
B_glm.sabl_no7no8_no65immature_07_18 <- vector.sabl_no7no8_no65immature_07_18[2]
Lmat50.sabl_no7no8_no65immature_07_18 = -(A_glm.sabl_no7no8_no65immature_07_18/B_glm.sabl_no7no8_no65immature_07_18)
Lmat50.sabl_no7no8_no65immature_07_18

cor(sabl_f_no7no8_no65immature_07_18$length_cm, sabl_f_no7no8_no65immature_07_18$macro_maturity)

sA.sabl_no7no8_no65immature_07_18 <- summary (fit.mat.glm.sabl_no7no8_no65immature_07_18)$coef[1,2] 
sB.sabl_no7no8_no65immature_07_18 <- summary (fit.mat.glm.sabl_no7no8_no65immature_07_18)$coef[2,2]    
r.sabl_no7no8_no65immature_07_18 <-cor(sabl_f_no7no8_no65immature_07_18$length_cm, sabl_f_no7no8_no65immature_07_18$macro_maturity)
n.1 <- length(sabl_f_no7no8_no65immature_07_18$length_cm)

#Variance estimator
deltamethod.sabl_no7no8_no65immature_07_18 <- ((sA.sabl_no7no8_no65immature_07_18^2)/(B_glm.sabl_no7no8_no65immature_07_18^2))- ((2*A_glm.sabl_no7no8_no65immature_07_18*sA.sabl_no7no8_no65immature_07_18*sB.sabl_no7no8_no65immature_07_18*r.sabl_no7no8_no65immature_07_18)/(B_glm.sabl_no7no8_no65immature_07_18^3))+ (((A_glm.sabl_no7no8_no65immature_07_18^2)*(sB.sabl_no7no8_no65immature_07_18^2))/(B_glm.sabl_no7no8_no65immature_07_18^4))
deltamethod.sabl_no7no8_no65immature_07_18

## 95% Confidence Interval equation

con.sabl_no7no8_no65immature_07_18 <- 1.96*(sqrt(deltamethod.sabl_no7no8_no65immature_07_18)/sqrt(n.1))
sabl_no7no8_no65immature_07_18_mat = c(Lmat50.sabl_no7no8_no65immature_07_18,con.sabl_no7no8_no65immature_07_18)
```

### Spawning season, all codes and no fish >= 65 cm that are immature
```{r fit_glm_sabl_allcodes_no65immature}
### 1995-2001 ###
fit.mat.glm.sabl_spwn_no65immature_95_01 <- glm(maturity ~ 1 + length, data <-data.frame(length = sabl_f_spwn_no65immature_95_01$length_cm, maturity <- sabl_f_spwn_no65immature_95_01$macro_maturity),
                                                       family = binomial(link ="logit"))
vector.sabl_spwn_no65immature_95_01 = c(fit.mat.glm.sabl_spwn_no65immature_95_01$coefficients)

# A_glm = intercept
# B_glm = slope

A_glm.sabl_spwn_no65immature_95_01 <- vector.sabl_spwn_no65immature_95_01[1] 
B_glm.sabl_spwn_no65immature_95_01 <- vector.sabl_spwn_no65immature_95_01[2]
Lmat50.sabl_spwn_no65immature_95_01 = -(A_glm.sabl_spwn_no65immature_95_01/B_glm.sabl_spwn_no65immature_95_01)
Lmat50.sabl_spwn_no65immature_95_01

cor(sabl_f_spwn_no65immature_95_01$length_cm, sabl_f_spwn_no65immature_95_01$macro_maturity)

sA.sabl_spwn_no65immature_95_01 <- summary (fit.mat.glm.sabl_spwn_no65immature_95_01)$coef[1,2] 
sB.sabl_spwn_no65immature_95_01 <- summary (fit.mat.glm.sabl_spwn_no65immature_95_01)$coef[2,2]    
r.sabl_spwn_no65immature_95_01 <-cor(sabl_f_spwn_no65immature_95_01$length_cm, sabl_f_spwn_no65immature_95_01$macro_maturity)
n.1 <- length(sabl_f_spwn_no65immature_95_01$length_cm)

#Variance estimator
deltamethod.sabl_spwn_no65immature_95_01 <- ((sA.sabl_spwn_no65immature_95_01^2)/(B_glm.sabl_spwn_no65immature_95_01^2))- ((2*A_glm.sabl_spwn_no65immature_95_01*sA.sabl_spwn_no65immature_95_01*sB.sabl_spwn_no65immature_95_01*r.sabl_spwn_no65immature_95_01)/(B_glm.sabl_spwn_no65immature_95_01^3))+ (((A_glm.sabl_spwn_no65immature_95_01^2)*(sB.sabl_spwn_no65immature_95_01^2))/(B_glm.sabl_spwn_no65immature_95_01^4))
deltamethod.sabl_spwn_no65immature_95_01

## 95% Confidence Interval equation

con.sabl_spwn_no65immature_95_01 <- 1.96*(sqrt(deltamethod.sabl_spwn_no65immature_95_01)/sqrt(n.1))
sabl_spwn_no65immature_95_01_mat = c(Lmat50.sabl_spwn_no65immature_95_01,con.sabl_spwn_no65immature_95_01)


### 2007-2018 ###

fit.mat.glm.sabl_spwn_no65immature_07_18 <- glm(maturity ~ 1 + length, data <-data.frame(length = sabl_f_spwn_no65immature_07_18$length_cm, maturity <- sabl_f_spwn_no65immature_07_18$macro_maturity),
                                                       family = binomial(link ="logit"))
vector.sabl_spwn_no65immature_07_18 = c(fit.mat.glm.sabl_spwn_no65immature_07_18$coefficients)

# A_glm = intercept
# B_glm = slope

A_glm.sabl_spwn_no65immature_07_18 <- vector.sabl_spwn_no65immature_07_18[1] 
B_glm.sabl_spwn_no65immature_07_18 <- vector.sabl_spwn_no65immature_07_18[2]
Lmat50.sabl_spwn_no65immature_07_18 = -(A_glm.sabl_spwn_no65immature_07_18/B_glm.sabl_spwn_no65immature_07_18)
Lmat50.sabl_spwn_no65immature_07_18

cor(sabl_f_spwn_no65immature_07_18$length_cm, sabl_f_spwn_no65immature_07_18$macro_maturity)

sA.sabl_spwn_no65immature_07_18 <- summary (fit.mat.glm.sabl_spwn_no65immature_07_18)$coef[1,2] 
sB.sabl_spwn_no65immature_07_18 <- summary (fit.mat.glm.sabl_spwn_no65immature_07_18)$coef[2,2]    
r.sabl_spwn_no65immature_07_18 <-cor(sabl_f_spwn_no65immature_07_18$length_cm, sabl_f_spwn_no65immature_07_18$macro_maturity)
n.1 <- length(sabl_f_spwn_no65immature_07_18$length_cm)

#Variance estimator
deltamethod.sabl_spwn_no65immature_07_18 <- ((sA.sabl_spwn_no65immature_07_18^2)/(B_glm.sabl_spwn_no65immature_07_18^2))- ((2*A_glm.sabl_spwn_no65immature_07_18*sA.sabl_spwn_no65immature_07_18*sB.sabl_spwn_no65immature_07_18*r.sabl_spwn_no65immature_07_18)/(B_glm.sabl_spwn_no65immature_07_18^3))+ (((A_glm.sabl_spwn_no65immature_07_18^2)*(sB.sabl_spwn_no65immature_07_18^2))/(B_glm.sabl_spwn_no65immature_07_18^4))
deltamethod.sabl_spwn_no65immature_07_18

## 95% Confidence Interval equation

con.sabl_spwn_no65immature_07_18 <- 1.96*(sqrt(deltamethod.sabl_spwn_no65immature_07_18)/sqrt(n.1))
sabl_spwn_no65immature_07_18_mat = c(Lmat50.sabl_spwn_no65immature_07_18,con.sabl_spwn_no65immature_07_18)
```
### Spawning season, no 7s no 8s and no fish >= 65 cm that are immature
```{r fit_glm_sabl_no7no8_no65immature}
### 1995-2001 ###
fit.mat.glm.sabl_spwn_no65immature_no7no8_95_01 <- glm(maturity ~ 1 + length, data <-data.frame(length = sabl_f_spwn_no65immature_no7no8_95_01$length_cm, maturity <- sabl_f_spwn_no65immature_no7no8_95_01$macro_maturity),
                                                       family = binomial(link ="logit"))
vector.sabl_spwn_no65immature_no7no8_95_01 = c(fit.mat.glm.sabl_spwn_no65immature_no7no8_95_01$coefficients)

# A_glm = intercept
# B_glm = slope

A_glm.sabl_spwn_no65immature_no7no8_95_01 <- vector.sabl_spwn_no65immature_no7no8_95_01[1] 
B_glm.sabl_spwn_no65immature_no7no8_95_01 <- vector.sabl_spwn_no65immature_no7no8_95_01[2]
Lmat50.sabl_spwn_no65immature_no7no8_95_01 = -(A_glm.sabl_spwn_no65immature_no7no8_95_01/B_glm.sabl_spwn_no65immature_no7no8_95_01)
Lmat50.sabl_spwn_no65immature_no7no8_95_01

cor(sabl_f_spwn_no65immature_no7no8_95_01$length_cm, sabl_f_spwn_no65immature_no7no8_95_01$macro_maturity)

sA.sabl_spwn_no65immature_no7no8_95_01 <- summary (fit.mat.glm.sabl_spwn_no65immature_no7no8_95_01)$coef[1,2] 
sB.sabl_spwn_no65immature_no7no8_95_01 <- summary (fit.mat.glm.sabl_spwn_no65immature_no7no8_95_01)$coef[2,2]    
r.sabl_spwn_no65immature_no7no8_95_01 <-cor(sabl_f_spwn_no65immature_no7no8_95_01$length_cm, sabl_f_spwn_no65immature_no7no8_95_01$macro_maturity)
n.1 <- length(sabl_f_spwn_no65immature_no7no8_95_01$length_cm)

#Variance estimator
deltamethod.sabl_spwn_no65immature_no7no8_95_01 <- ((sA.sabl_spwn_no65immature_no7no8_95_01^2)/(B_glm.sabl_spwn_no65immature_no7no8_95_01^2))- ((2*A_glm.sabl_spwn_no65immature_no7no8_95_01*sA.sabl_spwn_no65immature_no7no8_95_01*sB.sabl_spwn_no65immature_no7no8_95_01*r.sabl_spwn_no65immature_no7no8_95_01)/(B_glm.sabl_spwn_no65immature_no7no8_95_01^3))+ (((A_glm.sabl_spwn_no65immature_no7no8_95_01^2)*(sB.sabl_spwn_no65immature_no7no8_95_01^2))/(B_glm.sabl_spwn_no65immature_no7no8_95_01^4))
deltamethod.sabl_spwn_no65immature_no7no8_95_01

## 95% Confidence Interval equation

con.sabl_spwn_no65immature_no7no8_95_01 <- 1.96*(sqrt(deltamethod.sabl_spwn_no65immature_no7no8_95_01)/sqrt(n.1))
sabl_spwn_no65immature_no7no8_95_01_mat = c(Lmat50.sabl_spwn_no65immature_no7no8_95_01,con.sabl_spwn_no65immature_no7no8_95_01)


### 2007-2018 ###

fit.mat.glm.sabl_spwn_no65immature_no7no8_07_18 <- glm(maturity ~ 1 + length, data <-data.frame(length = sabl_f_spwn_no65immature_no7no8_07_18$length_cm, maturity <- sabl_f_spwn_no65immature_no7no8_07_18$macro_maturity),
                                                       family = binomial(link ="logit"))
vector.sabl_spwn_no65immature_no7no8_07_18 = c(fit.mat.glm.sabl_spwn_no65immature_no7no8_07_18$coefficients)

# A_glm = intercept
# B_glm = slope

A_glm.sabl_spwn_no65immature_no7no8_07_18 <- vector.sabl_spwn_no65immature_no7no8_07_18[1] 
B_glm.sabl_spwn_no65immature_no7no8_07_18 <- vector.sabl_spwn_no65immature_no7no8_07_18[2]
Lmat50.sabl_spwn_no65immature_no7no8_07_18 = -(A_glm.sabl_spwn_no65immature_no7no8_07_18/B_glm.sabl_spwn_no65immature_no7no8_07_18)
Lmat50.sabl_spwn_no65immature_no7no8_07_18

cor(sabl_f_spwn_no65immature_no7no8_07_18$length_cm, sabl_f_spwn_no65immature_no7no8_07_18$macro_maturity)

sA.sabl_spwn_no65immature_no7no8_07_18 <- summary (fit.mat.glm.sabl_spwn_no65immature_no7no8_07_18)$coef[1,2] 
sB.sabl_spwn_no65immature_no7no8_07_18 <- summary (fit.mat.glm.sabl_spwn_no65immature_no7no8_07_18)$coef[2,2]    
r.sabl_spwn_no65immature_no7no8_07_18 <-cor(sabl_f_spwn_no65immature_no7no8_07_18$length_cm, sabl_f_spwn_no65immature_no7no8_07_18$macro_maturity)
n.1 <- length(sabl_f_spwn_no65immature_no7no8_07_18$length_cm)

#Variance estimator
deltamethod.sabl_spwn_no65immature_no7no8_07_18 <- ((sA.sabl_spwn_no65immature_no7no8_07_18^2)/(B_glm.sabl_spwn_no65immature_no7no8_07_18^2))- ((2*A_glm.sabl_spwn_no65immature_no7no8_07_18*sA.sabl_spwn_no65immature_no7no8_07_18*sB.sabl_spwn_no65immature_no7no8_07_18*r.sabl_spwn_no65immature_no7no8_07_18)/(B_glm.sabl_spwn_no65immature_no7no8_07_18^3))+ (((A_glm.sabl_spwn_no65immature_no7no8_07_18^2)*(sB.sabl_spwn_no65immature_no7no8_07_18^2))/(B_glm.sabl_spwn_no65immature_no7no8_07_18^4))
deltamethod.sabl_spwn_no65immature_no7no8_07_18

## 95% Confidence Interval equation

con.sabl_spwn_no65immature_no7no8_07_18 <- 1.96*(sqrt(deltamethod.sabl_spwn_no65immature_no7no8_07_18)/sqrt(n.1))
sabl_spwn_no65immature_no7no8_07_18_mat = c(Lmat50.sabl_spwn_no65immature_no7no8_07_18,con.sabl_spwn_no65immature_no7no8_07_18)
```
...
### All seasons, all codes, no immature fish >= 65 cm
```{r get_parameters_sabl_allcodes_allseasons_no65immature}
# 1995-2001 # 
bin_sabl_f_no65immature_95_01 <- sabl_prop_mature_f_no65immature_95_01$length_cm
prop_sabl_f_no65immature_95_01 <- sabl_prop_mature_f_no65immature_95_01$prop_mature
n_sabl_f_no65immature_95_01 <- sabl_prop_mature_f_no65immature_95_01$n
fit.mat.glm.sabl_f_no65immature_95_01[1]
df.fit.mat.glm.sabl_f_no65immature_95_01 = as.data.frame(fit.mat.glm.sabl_f_no65immature_95_01[1])
A_glm.sabl_f_no65immature_95_01 = df.fit.mat.glm.sabl_f_no65immature_95_01$coefficients[1]
B_glm.sabl_f_no65immature_95_01 = df.fit.mat.glm.sabl_f_no65immature_95_01$coefficients[2]

# 2007-2018 # 
bin_sabl_f_no65immature_07_18 <- sabl_prop_mature_f_no65immature_07_18$length_cm
prop_sabl_f_no65immature_07_18 <- sabl_prop_mature_f_no65immature_07_18$prop_mature
n_sabl_f_no65immature_07_18 <- sabl_prop_mature_f_no65immature_07_18$n
fit.mat.glm.sabl_f_no65immature_07_18[1]
df.fit.mat.glm.sabl_f_no65immature_07_18 = as.data.frame(fit.mat.glm.sabl_f_no65immature_07_18[1])
A_glm.sabl_f_no65immature_07_18 = df.fit.mat.glm.sabl_f_no65immature_07_18$coefficients[1]
B_glm.sabl_f_no65immature_07_18 = df.fit.mat.glm.sabl_f_no65immature_07_18$coefficients[2]
```
...
### CREATE PLOT
setEPS()
postscript(here("figures", "historical_sensitivity_analysis", "sabl_allseasons_allcodes_no65immature_histcomp.eps"), height = 8, width = 8)
...
# points(x = bin_m.2, y = prop_m.2,cex=0.7*sqrt(n_m.2), pch=16, col = rgb(0,0,1,0.2))
points(x = bin_sabl_f_no65immature_95_01, y = prop_sabl_f_no65immature_95_01,cex=0.7*sqrt(n_sabl_f_no65immature_95_01), pch=16, col = "#f4a582")
points(x = bin_sabl_f_no65immature_07_18, y = prop_sabl_f_no65immature_07_18,cex=0.7*sqrt(n_sabl_f_no65immature_07_18), pch=16, col = "#92c5de")


lines(30:83, 1/(1+(exp(-(A_glm.sabl_f_no65immature_95_01+(B_glm.sabl_f_no65immature_95_01*(30:83)))))), type = "l", col='#b2182b', pch = 19, lty =1,lwd = 3)####Time Period 2#####
lines(30:83, 1/(1+(exp(-(A_glm.sabl_f_no65immature_07_18+(B_glm.sabl_f_no65immature_07_18*(30:83)))))), type = "l", col='#2166ac', pch = 19, lty =1,lwd = 3)####Time Period 2#####

# GLM Confidence Bands #

plotdat <- data.frame(length=(30:83))
predat_sabl_f_no65immature_95_01 <- predict(fit.mat.glm.sabl_f_no65immature_95_01,newdata=plotdat, se.fit=TRUE)
with(predat_sabl_f_no65immature_95_01, lines(30:83,exp(fit+1.96*se.fit)/(1+exp(fit+1.96*se.fit)),lty=2,col="#b2182b"))
with(predat_sabl_f_no65immature_95_01, lines(30:83,exp(fit-1.96*se.fit)/(1+exp(fit-1.96*se.fit)),lty=2,col="#b2182b"))

predat_sabl_f_no65immature_07_18 <- predict(fit.mat.glm.sabl_f_no65immature_07_18,newdata=plotdat, se.fit=TRUE)
with(predat_sabl_f_no65immature_07_18, lines(30:83,exp(fit+1.96*se.fit)/(1+exp(fit+1.96*se.fit)),lty=2,col="#2166ac"))
with(predat_sabl_f_no65immature_07_18, lines(30:83,exp(fit-1.96*se.fit)/(1+exp(fit-1.96*se.fit)),lty=2,col="#2166ac"))
...
### All seasons, no 7s no 8s and no fish >= 65 cm that are immature
```{r get_parameters_sabl_no7no8_allseasons_no7no8_no65immature}
# 1995-2001 # 
bin_sabl_f_no7no8_no65immature_95_01 <- sabl_prop_mature_f_no7no8_no65immature_95_01$length_cm
prop_sabl_f_no7no8_no65immature_95_01 <- sabl_prop_mature_f_no7no8_no65immature_95_01$prop_mature
n_sabl_f_no7no8_no65immature_95_01 <- sabl_prop_mature_f_no7no8_no65immature_95_01$n
fit.mat.glm.sabl_no7no8_no65immature_95_01[1]
df.fit.mat.glm.sabl_no7no8_no65immature_95_01 = as.data.frame(fit.mat.glm.sabl_no7no8_no65immature_95_01[1])
A_glm.sabl_f_no7no8_no65immature_95_01 = df.fit.mat.glm.sabl_no7no8_no65immature_95_01$coefficients[1]
B_glm.sabl_f_no7no8_no65immature_95_01 = df.fit.mat.glm.sabl_no7no8_no65immature_95_01$coefficients[2]

# 2007-2018 # 
bin_sabl_f_no7no8_no65immature_07_18 <- sabl_prop_mature_f_no7no8_no65immature_07_18$length_cm
prop_sabl_f_no7no8_no65immature_07_18 <- sabl_prop_mature_f_no7no8_no65immature_07_18$prop_mature
n_sabl_f_no7no8_no65immature_07_18 <- sabl_prop_mature_f_no7no8_no65immature_07_18$n
fit.mat.glm.sabl_no7no8_no65immature_07_18[1]
df.fit.mat.glm.sabl_no7no8_no65immature_07_18 = as.data.frame(fit.mat.glm.sabl_no7no8_no65immature_07_18[1])
A_glm.sabl_f_no7no8_no65immature_07_18 = df.fit.mat.glm.sabl_no7no8_no65immature_07_18$coefficients[1]
B_glm.sabl_f_no7no8_no65immature_07_18 = df.fit.mat.glm.sabl_no7no8_no65immature_07_18$coefficients[2]
```
...
### CREATE PLOT
setEPS()
postscript(here("figures", "historical_sensitivity_analysis", "sabl_allseasons_no7no8_no65immature_histcomp.eps"), height = 8, width = 8)
...
# points(x = bin_m.2, y = prop_m.2,cex=0.7*sqrt(n_m.2), pch=16, col = rgb(0,0,1,0.2))
points(x = bin_sabl_f_no7no8_no65immature_95_01, y = prop_sabl_f_no7no8_no65immature_95_01,cex=0.7*sqrt(n_sabl_f_no7no8_no65immature_95_01), pch=16, col = "#f4a582")
points(x = bin_sabl_f_no7no8_no65immature_07_18, y = prop_sabl_f_no7no8_no65immature_07_18,cex=0.7*sqrt(n_sabl_f_no7no8_no65immature_07_18), pch=16, col = "#92c5de")


lines(30:83, 1/(1+(exp(-(A_glm.sabl_f_no7no8_no65immature_95_01+(B_glm.sabl_f_no7no8_no65immature_95_01*(30:83)))))), type = "l", col='#b2182b', pch = 19, lty =1,lwd = 3)####Time Period 2#####
lines(30:83, 1/(1+(exp(-(A_glm.sabl_f_no7no8_no65immature_07_18+(B_glm.sabl_f_no7no8_no65immature_07_18*(30:83)))))), type = "l", col='#2166ac', pch = 19, lty =1,lwd = 3)####Time Period 2#####

# GLM Confidence Bands #

plotdat <- data.frame(length=(30:83))
predat_sabl_f_no7no8_no65immature_95_01 <- predict(fit.mat.glm.sabl_no7no8_no65immature_95_01,newdata=plotdat, se.fit=TRUE)
with(predat_sabl_f_no7no8_no65immature_95_01, lines(30:83,exp(fit+1.96*se.fit)/(1+exp(fit+1.96*se.fit)),lty=2,col="#b2182b"))
with(predat_sabl_f_no7no8_no65immature_95_01, lines(30:83,exp(fit-1.96*se.fit)/(1+exp(fit-1.96*se.fit)),lty=2,col="#b2182b"))

predat_sabl_f_no7no8_no65immature_07_18 <- predict(fit.mat.glm.sabl_no7no8_no65immature_07_18,newdata=plotdat, se.fit=TRUE)
with(predat_sabl_f_no7no8_no65immature_07_18, lines(30:83,exp(fit+1.96*se.fit)/(1+exp(fit+1.96*se.fit)),lty=2,col="#2166ac"))
with(predat_sabl_f_no7no8_no65immature_07_18, lines(30:83,exp(fit-1.96*se.fit)/(1+exp(fit-1.96*se.fit)),lty=2,col="#2166ac"))
...
### Spawning season, all codes, no immature fish >= 65 cm
```{r get_parameters_sabl_allcodes_spwn_no65immature}
# 1995-2001 # 
bin_sabl_f_spwn_no65immature_95_01 <- sabl_prop_mature_f_spwn_no65immature_95_01$length_cm
prop_sabl_f_spwn_no65immature_95_01 <- sabl_prop_mature_f_spwn_no65immature_95_01$prop_mature
n_sabl_f_spwn_no65immature_95_01 <- sabl_prop_mature_f_spwn_no65immature_95_01$n
fit.mat.glm.sabl_spwn_no65immature_95_01[1]
df.fit.mat.glm.sabl_spwn_no65immature_95_01 = as.data.frame(fit.mat.glm.sabl_spwn_no65immature_95_01[1])
A_glm.sabl_f_spwn_no65immature_95_01 = df.fit.mat.glm.sabl_spwn_no65immature_95_01$coefficients[1]
B_glm.sabl_f_spwn_no65immature_95_01 = df.fit.mat.glm.sabl_spwn_no65immature_95_01$coefficients[2]

# 2007-2018 # 
bin_sabl_f_spwn_no65immature_07_18 <- sabl_prop_mature_f_spwn_no65immature_07_18$length_cm
prop_sabl_f_spwn_no65immature_07_18 <- sabl_prop_mature_f_spwn_no65immature_07_18$prop_mature
n_sabl_f_spwn_no65immature_07_18 <- sabl_prop_mature_f_spwn_no65immature_07_18$n
fit.mat.glm.sabl_spwn_no65immature_07_18[1]
df.fit.mat.glm.sabl_spwn_no65immature_07_18 = as.data.frame(fit.mat.glm.sabl_spwn_no65immature_07_18[1])
A_glm.sabl_f_spwn_no65immature_07_18 = df.fit.mat.glm.sabl_spwn_no65immature_07_18$coefficients[1]
B_glm.sabl_f_spwn_no65immature_07_18 = df.fit.mat.glm.sabl_spwn_no65immature_07_18$coefficients[2]
```
...
### CREATE PLOT
setEPS()
postscript(here("figures", "historical_sensitivity_analysis", "sabl_allseasons_allcodes_spwn_no65immature_histcomp.eps"), height = 8, width = 8)
...
# points(x = bin_m.2, y = prop_m.2,cex=0.7*sqrt(n_m.2), pch=16, col = rgb(0,0,1,0.2))
points(x = bin_sabl_f_spwn_no65immature_95_01, y = prop_sabl_f_spwn_no65immature_95_01,cex=0.7*sqrt(n_sabl_f_spwn_no65immature_95_01), pch=16, col = "#f4a582")
points(x = bin_sabl_f_spwn_no65immature_07_18, y = prop_sabl_f_spwn_no65immature_07_18,cex=0.7*sqrt(n_sabl_f_spwn_no65immature_07_18), pch=16, col = "#92c5de")


lines(30:83, 1/(1+(exp(-(A_glm.sabl_f_spwn_no65immature_95_01+(B_glm.sabl_f_spwn_no65immature_95_01*(30:83)))))), type = "l", col='#b2182b', pch = 19, lty =1,lwd = 3)####Time Period 2#####
lines(30:83, 1/(1+(exp(-(A_glm.sabl_f_spwn_no65immature_07_18+(B_glm.sabl_f_spwn_no65immature_07_18*(30:83)))))), type = "l", col='#2166ac', pch = 19, lty =1,lwd = 3)####Time Period 2#####

# GLM Confidence Bands #

plotdat <- data.frame(length=(30:83))
predat_sabl_f_spwn_no65immature_95_01 <- predict(fit.mat.glm.sabl_spwn_no65immature_95_01,newdata=plotdat, se.fit=TRUE)
with(predat_sabl_f_spwn_no65immature_95_01, lines(30:83,exp(fit+1.96*se.fit)/(1+exp(fit+1.96*se.fit)),lty=2,col="#b2182b"))
with(predat_sabl_f_spwn_no65immature_95_01, lines(30:83,exp(fit-1.96*se.fit)/(1+exp(fit-1.96*se.fit)),lty=2,col="#b2182b"))

predat_sabl_f_spwn_no65immature_07_18 <- predict(fit.mat.glm.sabl_spwn_no65immature_07_18,newdata=plotdat, se.fit=TRUE)
with(predat_sabl_f_spwn_no65immature_07_18, lines(30:83,exp(fit+1.96*se.fit)/(1+exp(fit+1.96*se.fit)),lty=2,col="#2166ac"))
with(predat_sabl_f_spwn_no65immature_07_18, lines(30:83,exp(fit-1.96*se.fit)/(1+exp(fit-1.96*se.fit)),lty=2,col="#2166ac"))
...
### FIG 3: Spawning season, no 7s no 8s and no fish >= 65 cm that are immature
```{r get_parameters_sabl_no7no8_spwn_no65immature}
# 1995-2001 # 
bin_sabl_f_no7no8_spwn_no65immature_95_01 <- sabl_prop_mature_f_spwn_no65immature_no7no8_95_01$length_cm
prop_sabl_f_no7no8_spwn_no65immature_95_01 <- sabl_prop_mature_f_spwn_no65immature_no7no8_95_01$prop_mature
n_sabl_f_no7no8_spwn_no65immature_95_01 <- sabl_prop_mature_f_spwn_no65immature_no7no8_95_01$n
fit.mat.glm.sabl_spwn_no65immature_no7no8_95_01[1]
df.fit.mat.glm.sabl_spwn_no65immature_no7no8_95_01 = as.data.frame(fit.mat.glm.sabl_spwn_no65immature_no7no8_95_01[1])
A_glm.sabl_f_no7no8_spwn_no65immature_95_01 = df.fit.mat.glm.sabl_spwn_no65immature_no7no8_95_01$coefficients[1]
B_glm.sabl_f_no7no8_spwn_no65immature_95_01 = df.fit.mat.glm.sabl_spwn_no65immature_no7no8_95_01$coefficients[2]

# 2007-2018 # 
bin_sabl_f_no7no8_spwn_no65immature_07_18 <- sabl_prop_mature_f_spwn_no65immature_no7no8_07_18$length_cm
prop_sabl_f_no7no8_spwn_no65immature_07_18 <- sabl_prop_mature_f_spwn_no65immature_no7no8_07_18$prop_mature
n_sabl_f_no7no8_spwn_no65immature_07_18 <- sabl_prop_mature_f_spwn_no65immature_no7no8_07_18$n
fit.mat.glm.sabl_spwn_no65immature_no7no8_07_18[1]
df.fit.mat.glm.sabl_spwn_no65immature_no7no8_07_18 = as.data.frame(fit.mat.glm.sabl_spwn_no65immature_no7no8_07_18[1])
A_glm.sabl_f_no7no8_spwn_no65immature_07_18 = df.fit.mat.glm.sabl_spwn_no65immature_no7no8_07_18$coefficients[1]
B_glm.sabl_f_no7no8_spwn_no65immature_07_18 = df.fit.mat.glm.sabl_spwn_no65immature_no7no8_07_18$coefficients[2]
```
...
### CREATE PLOT
setEPS()
postscript(here("figures", "historical_sensitivity_analysis", "sabl_no7no8_spwn_no65immature_histcomp.eps"), height = 8, width = 8)
...
# points(x = bin_m.2, y = prop_m.2,cex=0.7*sqrt(n_m.2), pch=16, col = rgb(0,0,1,0.2))
points(x = bin_sabl_f_no7no8_spwn_no65immature_95_01, y = prop_sabl_f_no7no8_spwn_no65immature_95_01,cex=0.7*sqrt(n_sabl_f_no7no8_spwn_no65immature_95_01), pch=16, col = "#f4a582")
points(x = bin_sabl_f_no7no8_spwn_no65immature_07_18, y = prop_sabl_f_no7no8_spwn_no65immature_07_18,cex=0.7*sqrt(n_sabl_f_no7no8_spwn_no65immature_07_18), pch=16, col = "#92c5de")


lines(30:83, 1/(1+(exp(-(A_glm.sabl_f_no7no8_spwn_no65immature_95_01+(B_glm.sabl_f_no7no8_spwn_no65immature_95_01*(30:83)))))), type = "l", col='#b2182b', pch = 19, lty =1,lwd = 3)####Time Period 2#####
lines(30:83, 1/(1+(exp(-(A_glm.sabl_f_no7no8_spwn_no65immature_07_18+(B_glm.sabl_f_no7no8_spwn_no65immature_07_18*(30:83)))))), type = "l", col='#2166ac', pch = 19, lty =1,lwd = 3)####Time Period 2#####

# GLM Confidence Bands #

plotdat <- data.frame(length=(30:83))
predat_sabl_f_no7no8_spwn_no65immature_95_01 <- predict(fit.mat.glm.sabl_spwn_no65immature_no7no8_95_01,newdata=plotdat, se.fit=TRUE)
with(predat_sabl_f_no7no8_spwn_no65immature_95_01, lines(30:83,exp(fit+1.96*se.fit)/(1+exp(fit+1.96*se.fit)),lty=2,col="#b2182b"))
with(predat_sabl_f_no7no8_spwn_no65immature_95_01, lines(30:83,exp(fit-1.96*se.fit)/(1+exp(fit-1.96*se.fit)),lty=2,col="#b2182b"))

predat_sabl_f_no7no8_spwn_no65immature_07_18 <- predict(fit.mat.glm.sabl_spwn_no65immature_no7no8_07_18,newdata=plotdat, se.fit=TRUE)
with(predat_sabl_f_no7no8_spwn_no65immature_07_18, lines(30:83,exp(fit+1.96*se.fit)/(1+exp(fit+1.96*se.fit)),lty=2,col="#2166ac"))
with(predat_sabl_f_no7no8_spwn_no65immature_07_18, lines(30:83,exp(fit-1.96*se.fit)/(1+exp(fit-1.96*se.fit)),lty=2,col="#2166ac"))
